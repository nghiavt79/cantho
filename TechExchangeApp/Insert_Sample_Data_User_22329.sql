-- =============================================
-- Script: Insert Sample Dashboard Data for UserId 22329 (INT version)
-- Description: Create sample projects, members, and steps for testing Dashboard
-- =============================================

-- Set specific user ID
DECLARE @UserId INT = 22329; -- INT to match database schema

PRINT 'Using UserId: ' + CAST(@UserId AS NVARCHAR(50));

-- Verify user exists
IF NOT EXISTS (SELECT * FROM Users WHERE UserId = @UserId)
BEGIN
    PRINT 'ERROR: User with ID 22329 not found in Users table.';
    PRINT 'Please verify the user exists first.';
    RETURN;
END

PRINT 'User found. Creating sample data...';
...
BEGIN
    ...
    PRINT 'Project 1 already exists (ID: ' + CAST(@Project1Id AS NVARCHAR(10)) + ')';
END
...
BEGIN
    ...
    PRINT 'Project 2 already exists (ID: ' + CAST(@Project2Id AS NVARCHAR(10)) + ')';
END
...
BEGIN
    ...
    PRINT 'Project 3 already exists (ID: ' + CAST(@Project3Id AS NVARCHAR(10)) + ')';
END
...
BEGIN
    ...
    PRINT 'Added user 22329 as Buyer to Project 1';
END
ELSE
BEGIN
    PRINT 'User 22329 already a member of Project 1';
END
...
BEGIN
    ...
    PRINT 'Added user 22329 as Seller to Project 2';
END
ELSE
BEGIN
    PRINT 'User 22329 already a member of Project 2';
END
...
BEGIN
    ...
    PRINT 'Added user 22329 as Consultant to Project 3';
END
ELSE
BEGIN
    PRINT 'User 22329 already a member of Project 3';
END
...
BEGIN
    ...
    SET @i = @i + 1;
END
PRINT 'Created 11 steps for Project 1 (all completed)';
...
BEGIN
    ...
    SET @i = @i + 1;
END
PRINT 'Created 11 steps for Project 2 (in progress at step 5)';
...
BEGIN
    ...
    SET @i = @i + 1;
END
PRINT 'Created 11 steps for Project 3 (just started)';

-- Summary
PRINT '';
PRINT '==============================================';
PRINT 'Sample data created successfully for User 22329!';
PRINT '==============================================';
...
PRINT '  - In Progress: 2 (PRJ-2024-002, PRJ-2024-003)';
PRINT '  - Completed: 1 (PRJ-2024-001)';
PRINT '  - Waiting For Me: 2';
PRINT '==============================================';
GO
