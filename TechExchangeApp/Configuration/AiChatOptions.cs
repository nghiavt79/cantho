namespace TechExchangeApp.Configuration
{
    public class AiChatOptions
    {
        ...
        public string BotName { get; set; } = "Trợ lý công nghệ CASTA";
        public string WelcomeMessage { get; set; } = "Xin chào! Tôi có thể giúp anh/chị tìm công nghệ, thiết bị, chuyên gia, nhà cung ứng hoặc gửi yêu cầu tư vấn.";
